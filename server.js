...
const teacherCommentSheetsAdminRoutes = require('./routes/teacherCommentSheetsAdmin');
...
app.use('/api/teacher-comment-sheets/admin', requireAuth, teacherCommentSheetsAdminRoutes);
